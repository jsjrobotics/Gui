...
public class I2CExample {
    ...
    // TSL2561 I2C address
    public static final int PARALLAX_EEPROM_ADDRESS = 0x00; // address pin not connected (FLOATING)
    //public static final int PARALLAX_EEPROM_ADDRESS = 0x29; // address pin connect to GND
    //public static final int PARALLAX_EEPROM_ADDRESS = 0x49; // address pin connected to VDD

    // TSL2561 registers
    public static final byte TEST_READ_ADDRESS = (byte)0x8000;
    ...
    public void run(JPanel parent) throws IOException, UnsupportedBusNumberException {
        // get the I2C bus to communicate on
        I2CBus i2c = I2CFactory.getInstance(I2CBus.BUS_1);

        // create an I2C device for an individual device on the bus that you want to communicate with
        // in this example we will use the default address for the TSL2561 chip which is 0x39.
        I2CDevice device = i2c.getDevice(PARALLAX_EEPROM_ADDRESS);
        ...
        int response = device.read(TEST_READ_ADDRESS);
        JOptionPane.showMessageDialog(parent, "EEPROM = " + String.format("%s", response) + " (should be abcdefg)");
